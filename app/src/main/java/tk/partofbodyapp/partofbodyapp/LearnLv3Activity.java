...
public class LearnLv3Activity extends AppCompatActivity implements ConsumeResponse{
    final String TAG = LearnLv3Activity.class.getCanonicalName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn_lv3);
...
//        });
    ...
    private void startDialog() {
        Dialog = ProgressDialog.show(LearnLv3Activity.this, "", "Connecting..");
        Dialog.setCancelable(false);
        jsonGetpartLv3 getpart = new jsonGetpartLv3();
...
//    }
    ...
    public void consumeResponse(JSONObject response) {
        ...
        if(response == null){
            Toast.makeText(LearnLv3Activity.this, "response is NULL", Toast.LENGTH_SHORT).show();
            ...
            Intent i = new Intent(LearnLv3Activity.this, LearnViewActivity.class);
            startActivity(i);
        }
    }
}
