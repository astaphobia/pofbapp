...
public class jsonGetpartLv3 extends AsyncTask<String, Void, JSONObject>{
    final String TAG = jsonGetpartLv3.class.getCanonicalName();
    final String url = "http://www.yenyenofficial.tk/json/json.php?name=";
    public ConsumeResponse delegated = null;
    String urlQuery = LearnLv3Activity.query;
